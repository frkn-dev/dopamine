    ...
    delegate: ColumnLayout {
        ...
        RadioButton {
            ...
            indicator: Rectangle {
                ...
                color: radioButton.hovered ? DopamineStyle.color.slateGray : DopamineStyle.color.onyxBlack
                border.color: radioButton.focus ? DopamineStyle.color.paleGray : DopamineStyle.color.transparent
